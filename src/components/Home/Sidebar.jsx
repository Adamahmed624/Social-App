...
export default function Sidebar({ sidebarLinks }) {
  return (
    <>
      <nav className="lg:hidden grid grid-cols-2 gap-3 bg-[#171B21] border border-[#262626] rounded-2xl p-2 space-y-1">
        {sidebarLinks.map((link) => (
          <NavLink
            ...
            className={({ isActive }) =>
              `w-full flex items-center gap-3 text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors ${isActive
